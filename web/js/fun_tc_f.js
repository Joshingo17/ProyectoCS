...
function loadMantenimientosPorCliente() {
    ...
    axios.get(`http://localhost:3000/mantenimientos_cliente?estado=finalizado&id_cliente=${id_cliente}`)
        .then(response => {
        ...
        .catch(error => {
            ...
            alert('Hubo un problema al cargar los mantenimientos. Por favor, intenta de nuevo más tarde.');
        });
}
